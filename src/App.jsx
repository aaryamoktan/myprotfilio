  ...
  return (
    <>
      <div className='w-full h-auto bg-black text-center !scroll-smooth' id="home">
        ...
        <div className='w-full flex flex-col justify-center items-center gap-10 h-auto text-center mt-[200px]' id="Projects">
        ...
        <div className="w-full h-[100vh] text-center" id="Contact">
          ...
          <div className='w-[50%] ml-[25%] mt-10 h-[80vh] rounded-2xl bg-[#FFFFFF]   '>
            ...
            <div className=''>
              <input type="text" className='w-[85%] rounded-2xl mt-10 h-[30vh] bg-[#ececec] text-start' placeholder='Message'/>
